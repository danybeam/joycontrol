"""
    This is a copy of run_test_controller_buttons.py without much altering
    as the project and my understanding advances I might trimm whatever is not relevant
    -- Danybeam
"""  
